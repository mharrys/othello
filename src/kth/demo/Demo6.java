...
public class Demo6 {
	...
	public static void main(String[] args) {
		Player player1 = new OthelloPlayer("p1", "Player 1", Player.Type.COMPUTER, new NaiveMoveStrategy());
		Player player2 = new OthelloPlayer("p2", "Player 2", Player.Type.COMPUTER, new NaiveMoveStrategy());
		Player player3 = new OthelloPlayer("p3", "Player 3", Player.Type.COMPUTER, new NaiveMoveStrategy());
